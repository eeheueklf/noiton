        ...
        <header className="mb-7">
            <div className="flex items-start justify-between px-1">
                ...
                <div className="flex items-center space-x-1 text-gray-400">
                    <button className="w-[10px] bg-black text-white px-10 py-4 rounded-xl font-bold text-lg hover:bg-gray-800 transition-all shadow-lg">
                    ...
                    <button className="w-full md:w-auto bg-black text-white px-10 py-4 rounded-xl font-bold text-lg hover:bg-gray-800 transition-all shadow-lg">
