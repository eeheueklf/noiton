...
NOITON은 노션 템플릿을 자유롭게 공유할 수 있는 플랫폼입니다.  
여러 템플릿 중 원하는 분류의 템플릿을 통해 원하는 템플릿을 찾을 수 있도록 지원합니다!

* notion 기반 자체 제작 사이트입니다.
...
├── types/          # TypeScript 인터페이스와 타입들
├── utils/          # 순수 유틸리티 함수
└── public/         # 전역으로 필요한 폰트, 이미지
```
